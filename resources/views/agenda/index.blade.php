...
<div class="max-w-7xl mx-auto">
        ...
        >
            ...
            <div class="flex justify-end gap-3 mt-5">
                ...
                <a
                    ...
                    class="px-5 py-2.5 border border-slate-300 rounded-lg
                ...
                <button
                    type="submit"
                    class="px-6 py-2.5 bg-teal-700 hover:bg-teal-800
    ...
    {{-- FECHA --}}
    <div class="mb-6 bg-white border border-slate-200 rounded-xl px-6 py-4 shadow-sm">
<div class="mb-6 bg-white border border-slate-200 rounded-xl
            px-6 py-4 shadow-sm flex flex-col md:flex-row
    ...
    <div>
        ...
        <div class="flex items-center gap-2">
            ...
            <a
                href="{{ route('agenda.index', [
                    'fecha' => \Carbon\Carbon::parse($fecha)->subDay()->toDateString()
                ]) }}"
            ...
            <a
                href="{{ route('agenda.index', [
                    'fecha' => \Carbon\Carbon::parse($fecha)->addDay()->toDateString()
                ]) }}"
                class="px-4 py-2 border border-slate-300 rounded-lg
                    text-sm font-semibold text-slate-600
                    hover:bg-slate-50 transition"
